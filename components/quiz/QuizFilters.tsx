    ...
    >
          ...
          <Badge
            ...
            className={cn(
              ...
              currentFilter === f.value
                ...
                : "bg-white/80 text-rose-600 border-rose-100 hover:border-pink-300 hover:bg-rose-50",
            )}
          >
            {f.label}
          </Badge>
      ...
      <div className="flex items-center gap-3">
        ...
        <Select value={currentSort} onValueChange={handleSortChange}>
          <SelectTrigger className="w-[160px] h-9 rounded-xl border-rose-100 bg-white/80 text-rose-900 focus:ring-pink-400">
